...
export default function Page() {
  return (
    <>
      ...
      <Script src="/cms-boot.js?v=20260805i" strategy="beforeInteractive" />
      {/* Core app scripts — afterInteractive so DOM from legacy body exists */}
      <Script src="/legacy-app.js?v=20260805i" strategy="afterInteractive" />
      ...
      <Script src="/legacy-bridge.js?v=20260805i" strategy="afterInteractive" />
      {/* Exam results self-entry, HOD pathways, live fees + multi K2 (manual paid tick) */}
      <Script src="/legacy-exam.js?v=20260805i" strategy="afterInteractive" />
      {/* Non-critical modules — defer so login paints faster / less main-thread freeze */}
      <Script src="/gpth-print.js?v=20260805i" strategy="lazyOnload" />
      <Script src="/legacy-tc.js?v=20260805i" strategy="lazyOnload" />
      <Script src="/legacy-acm-study.js?v=20260805i" strategy="lazyOnload" />
    </>
  )
}
